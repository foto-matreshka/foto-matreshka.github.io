...
function hootdu_add_welcome_notice() {
	...
	<div id="hoot-welcome-msg" class="notice notice-success is-dismissible">
		...
		<p><?php
			/* Translators: 1 is the link start markup, 2 is link markup end */
			printf( esc_html__( '%1$sGet started with Hoot Du%2$s', 'hoot-du' ), '<a class="button-secondary" href="' . esc_url( admin_url( 'themes.php?page=hoot-du-welcome' ) ) . '">', '</a>' );
			?></p>
	</div>
	<?php
}
...
function hootdu_dismiss_welcome_notice() {
	...
	update_option( 'hoot-du-dismiss-welcome', 1 ); // echo 'dismiss test';
	wp_die();
}
	...
	<div class="wrap">
		...
		<div id="hoot-about-sub" class="hoot-about-sub">
			...
			<div class="hoot-about-text">
				<p class="hoot-about-intro"><?php esc_html_e( 'Hoot Du is a multipurpose highly flexible WordPress theme built on a SEO friendly framework with fast loading speed. It comes with a lot of Customizer options, multiple blog layouts, WooCommerce support etc among many other features.', 'hoot-du' ) ?></p>
				...
				<?php do_action( 'hootdu_theme_after_about_textlinks' ); ?>
				<?php /*
		...
		<div class="hoot-abouttabs">
			...
			<h2 id="nav-tabs" class="nav-tab-wrapper">
				...
				<?php do_action( 'hootdu_theme_after_nav_tab_upsell', $activetab ); ?>
			...
			<?php do_action( 'hootdu_theme_after_hoot_upsell', $activetab ); ?>
