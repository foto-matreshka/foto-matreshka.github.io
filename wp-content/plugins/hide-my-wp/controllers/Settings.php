...
class HMW_Controllers_Settings extends HMW_Classes_FrontController {
    ...
    public function init() {
        ...
        if (HMW_Classes_Tools::getOption('hmw_mode') == 'lite') {
            HMW_Classes_Error::setError(sprintf(__("Special! Get %sHide My WP Ghost premium for 5 websites%s with %s65&#37; OFF%s today. %sGo to offer%s", _HMW_PLUGIN_NAME_), '<strong style="color: orangered">', '</strong>', '<strong style="color: orangered">', '</strong>', '<a href="https://hidemywpghost.com/buy/5_websites_special" target="_blank" style="font-weight: bold">', '</a>'));
        }
