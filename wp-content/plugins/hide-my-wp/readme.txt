...
Security through obscurity is the best solution for WordPress Security. Hide wp-admin, wp-login, plugin, themes, etc. Add Firewall, Brute Force protection & more.

== Description ==

[youtube https://www.youtube.com/watch?v=gwRKHQTNkh0]

**Hide My WP Ghost Lite** is a **WordPress Security plugin**. Changes and hides WordPress common paths for the Best WP Security against hacker's bots.

The plugin works like security through obscurity solution for a WP website.
...
Security through obscurity is the best solution against hacker's bots. This is the best way to protect vulnerable plugins and themes.
...
> *   <strong>Remove DNS Prefetch WordPress link</strong>
> *   <strong>Remove WordPress Generator Meta</strong>
...
> *   Remove DNS Prefetch WordPress link
