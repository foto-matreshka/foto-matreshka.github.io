                        ...
                        <div class="card-body">
                            ...
                            <?php } else { ?>
                                <div class="col-sm-12 row border-bottom border-light py-3 mx-0 ">
                                    <div class="p-0">
                                        <h4>
                                            <?php _e('Replace text by matching', _HMW_PLUGIN_NAME_); ?>:
                                            <a href="https://hidemywpghost.com/kb/url-mapping-text-mapping/#text_mapping" target="_blank" class="d-inline-block ml-2" ><i class="fa fa-question-circle"></i></a>
                                        </h4>
